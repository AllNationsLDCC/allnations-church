...
const YOUTH_IMG = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663485607175/TjWcJDkPBeGubtwr.jpeg"; // kids choir on stage
const TEAM_IMG_2 = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663485607175/UYcOAwuWKybPfrWV.jpeg"; // Sis. Marry Jean-Charles at podium
const SANCTUARY_IMG = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663485607175/dGXOKDvIKGhSqtqS.jpeg"; // sanctuary service
const YOUTH_BUS_IMG = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663485607175/KcQapATNcLZzPeDJ.jpeg"; // youth bus interior
const COSTUME_1 = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663485607175/slXpRXKpbVYdgJKV.jpeg"; // two kids in biblical costumes
const COSTUME_2 = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663485607175/nqGQpSYNUjIQIwRA.jpeg"; // child in high priest costume
