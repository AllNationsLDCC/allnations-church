...
const entries: DayEntry[] = [
  ...
  },
  {
    ...
    keyPoints: [
      ...
      "You weren't designed to just clock in and disappear. Wherever God placed you, He placed you on purpose. Your classroom, your job, your home — that is your assignment. Show up fully.",
      "Average people blend in, but you were designed to shine right where you are. Someone there may need to see Jesus in you today. That is not an accident — that is purpose.",
    ],
