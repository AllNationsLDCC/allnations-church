...
const entries: DayEntry[] = [
  ...
  },
  {
    ...
    keyPoints: [
      ...
      "You can be the one whose faith changes the atmosphere at home. You don't need everyone to agree first. You just need to make the decision and stand on it.",
      "God designed your family on purpose, and He can restore it. Everything He has built in you this month was never just for you — it was meant to flow through you into your home and your generations.",
    ],
