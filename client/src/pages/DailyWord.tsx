...
const entries: DayEntry[] = [
  ...
  },
  {
    ...
    keyPoints: [
      "Israel never had to guess which way God was leading. By day, a cloud. By night, a fire. The same God who moved in front of them wanted to be seen — and followed.",
      "Notice this: the fire showed up when the cloud could no longer be seen. When life gets dark, God does not disappear. He changes the way He shows Himself.",
      "If you are walking through a dark night right now — a season of uncertainty, loss, or confusion — look up. The pillar is still there. It may not look like what you were used to seeing during the day, but God has not stopped leading.",
    ],
  ...
  },
  {
    ...
    keyPoints: [
      ...
      "Our relationship with God works the same way. God sends the fire, yes. But we tend it. We put on the wood. We lay the offering in order.",
      "No one else can do this for you — not your pastor, not your spouse, not your small group leader. If the fire in your walk with God has grown low, it is not because God stopped showing up. It is because the altar has been unattended.",
    ],
  ...
  },
  {
    ...
    keyPoints: [
      ...
      "Some of us are trying to run today on yesterday's grace. We are tired because we are living out of an old supply. But fresh mercy is available the moment your eyes open.",
      "Receive it. Breathe it in. Let it reignite what has grown cold. The fire on your altar will never outlast the mercy of God — and His mercy is new every morning.",
    ],
  ...
  },
  {
    ...
    keyPoints: [
      "Elijah stood on Mount Carmel, outnumbered 450 to one. The prophets of Baal had cried out all day and gotten nothing. Then Elijah stepped up, soaked the altar with water, and prayed a simple prayer. The fire fell.",
      "It did not just touch the sacrifice. It consumed everything — the wood, the stones, the dust, the water. Complete. Total. Unmistakable.",
      "When God vindicates you, there will be no doubt. You do not have to defend yourself in every argument. You do not have to prove what God already knows. Keep serving. Keep praying. Keep walking in integrity.",
    ],
  ...
  },
  {
    ...
    keyPoints: [
      "God did not promise us that we would avoid the fire. He promised that when we walk through it, we will not be burned. Read that again. The fire is real — but so is His presence.",
      "Some fires do not come to destroy us; they come to display Him. You may be in a fiery season right now — a hard diagnosis, a strained relationship, a financial pressure, a spiritual battle.",
      "Hear the promise: you will not be burned. The flames may be hot, but they will not consume you. God is walking through this with you.",
    ],
