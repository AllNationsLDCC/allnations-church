...
const entries: DayEntry[] = [
  ...
  },
  {
    ...
    keyPoints: [
      ...
      "You were not designed to run on empty. You were designed to be carried by the One who made you. That is not weakness — that is wisdom. God never intended for you to carry the weight of your life alone.",
      "Start this week leaning on Him. Bring Him your exhaustion, your Monday, your full schedule, and your empty tank. He is not disappointed in your tiredness. He is waiting to be your rest.",
    ],
