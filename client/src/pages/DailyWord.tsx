...
const entries: DayEntry[] = [
  ...
  },
  {
    ...
    keyPoints: [
      "Watching the bills stack up? Jesus said, 'Don't worry, asking what shall we eat? Your heavenly Father knows that you need them.' The God who designed you knows exactly what you need before you ask.",
      "But seek first His kingdom and His righteousness, and all these things will be given to you as well. The order matters — seek God first, and provision follows. Not the other way around.",
      "The God who designed you didn't bring you this far to drop you now. Seek Him first. Trust Him with the rest. He has never failed to provide for what He created.",
    ],
