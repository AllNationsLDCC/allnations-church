...
const entries: DayEntry[] = [
  ...
  },
  {
    ...
    keyPoints: [
      "That racing heart, that 2:00 AM worry — God has a word for it. Do not be anxious about anything, but in every situation, by prayer and petition, present your requests to God.",
      "And the peace of God, which transcends all understanding, will guard your hearts. You are not designed to carry what only God can hold. Prayer is not a last resort — it is the first move.",
      "Hand it to Him this morning. Whatever is weighing on you — the situation, the relationship, the unknown — bring it to God specifically, with thanksgiving, and let His peace stand guard.",
    ],
